...
Usage="Example usage: .../scripts/run_DataFrameRunnable.sh \"
--patientTable db.patients
--physicianTable db.physicians
--physicianExcludedTable db.physicians_excluded
--selectedPatientTable db.patients_selected
...
CLASS_NAME_TO_LOAD="DataFrameRunnable"

SPARK_LOG="./run_DataFrameRunnable_"$(date '+%Y%m%d%H%M%S')".log"
